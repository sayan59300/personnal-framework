...
define(
    'ALPHABETIC',
    '/^([a-zA-Zéèçàùêâôîûäëïöü]+(([ \-\'])[a-zA-Zéèçàùêâôîûäëïöü]+)*)+(([ \-\'])([a-zA-Zéèçàùêâôîûäëïöü]+(([ \-\'])[a-zA-Zéèçàùêâôîûäëïöü]+)*)+)*$/'
);
define(
    'TEXT',
    '/^([a-zA-Z0-9éèçàùêâôîûäëïöü]+[\s]{0,1}|[\\\']{0,1}|[\-]{0,1}|[\,\.]{0,1}[\s]{1}|[\s]{1}[\:\;\!\?][\s]{1})+([\.]{1}|[\s][\?]{1}|[\s][\!]{1})$/'
);
